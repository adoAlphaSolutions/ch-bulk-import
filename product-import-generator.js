...
const CATEGORY_CONFIGS = {
  ...
  carpet: {
    ...
    fieldMap: {
      ...
      'toll color name': 'Color', 'toll color number': 'TB.PCM.Product.ColorNumber',
      'manufacturer name (private label)': 'TB.PCM.FlooringManufacturerFamilyName',
      'manufacturer style number (private label)': 'TB.PCM.FlooringManufacturerStyleNumber',
      'manufacturer color name (private label)': 'TB.PCM.FlooringManufacturerColorName',
      'manufacturer color number (private label)': 'TB.PCM.FlooringManufacturerColorNumber',
      'color family': 'TB.PCM.CarpetFlooringColorFamily', 'material': 'TB.PCM.CarpetFlooringMaterial',
      'style': 'TB.PCM.CarpetFlooringStyle', 'pattern size': 'TB.PCM.CarpetFlooringCarpetPatternSize',
